...
define config.name = _("Game by Scooby-Doo team")
...
define gui.about = _p("""
Визуальная новелла за авторством Скуби-Ду team:

Тимлид - {a=https://vk.com/id420756054}Айматова Шахзода{/a}

Гейм-Дизайнер - {a=https://vk.com/fn_dndln}Кочергин Михаил{/a}

Дизайнер - {a=https://vk.com/vershininaoart}Вершинина Ольга{/a}

Аналитик - {a=https://vk.com/arinatopor}Топор Арина{/a}

Разработчик - {a=https://vk.com/nshevchenko2015}Шевченко Никита{/a}
...
define build.name = "Scooby-Doo_team"
...
define config.main_menu_music = "audio/main_menu_old.mp3"
...
define config.save_directory = "ScoobyDoo-1665056172"
